...
| computer use | hosted browser computer tool configuration | [computer_use.rs](../crates/openai-agents/examples/computer_use.rs) |
...
| custom tool | Responses custom tool with raw string input and custom tool output replay | [custom_tool.rs](../crates/openai-agents/examples/custom_tool.rs) |
...
| memory session HITL | SQLite session memory with approval interruption resume | [memory_session_hitl.rs](../crates/openai-agents/examples/memory_session_hitl.rs) |
...
| mcp git | local Git MCP server tool discovery and tool calls | [mcp_git.rs](../crates/openai-agents/examples/mcp_git.rs) |
...
| mcp streamable HTTP remote | remote MCP streamable HTTP configuration with mocked tool outputs | [mcp_streamable_http_remote.rs](../crates/openai-agents/examples/mcp_streamable_http_remote.rs) |
...
| shell | local read-only shell command tool | [shell.rs](../crates/openai-agents/examples/shell.rs) |
| shell human in the loop | approval-gated local shell command tool | [shell_human_in_the_loop.rs](../crates/openai-agents/examples/shell_human_in_the_loop.rs) |
