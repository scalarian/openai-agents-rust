...
The canonical docs home is [index.md](index.md).

Open this directory when you want guides, curated reference, examples, or subsystem-specific docs.
...
- sandbox workspaces: [sandbox/guide.md](sandbox/guide.md), [sandbox/clients.md](sandbox/clients.md), [sandbox/memory.md](sandbox/memory.md), [sandbox_agents.md](sandbox_agents.md)
