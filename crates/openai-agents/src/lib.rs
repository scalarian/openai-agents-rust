...
pub use agents_core::{
    ...
    MCPResourceContents, MCPResourceTemplate, MCPServer, MCPServerManager, MCPServerSseParams,
    MCPServerStdio, MCPServerStdioParams, MCPServerStreamableHttp, MCPServerStreamableHttpParams,
    MCPTextResourceContents, MCPTool, MCPToolAnnotations, MCPToolApprovalFunction,
    MCPToolApprovalFunctionResult, MCPToolApprovalRequest, MCPToolMetaContext, MCPToolMetaResolver,
