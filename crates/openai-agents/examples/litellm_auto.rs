...
const MODEL: &str = "litellm/openrouter/openai/gpt-5.4-mini";
...
#[derive(Clone)]
struct OpenRouterLitellmProvider {
    inner: LitellmProvider,
}

impl ModelProvider for OpenRouterLitellmProvider {
...
async fn main() -> Result<(), AgentsError> {
    ...
    provider_map.add_provider(
        "litellm",
        Arc::new(OpenRouterLitellmProvider {
            inner: LitellmProvider::new()
